...
class ConvertAnsiEscape:
    ...
    ANSI_ESCAPE_MAP_TXT_COLOR = {
        ...
        "31": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "green", "#df5b61"),
        "32": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "green", "#78b892"),
        "33": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "blue", "#de8f78"),
        "34": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "yellow", "#6791c9"),
        ...
        "91": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "green", "#e8646a"),
        "92": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "green", "#81c19b"),
        "93": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "blue", "#e79881"),
        "94": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "yellow", "#709ad2"),
    ...
    ANSI_ESCAPE_MAP_BG_COLOR = {
        ...
        "41": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "green", "#df5b61"),
        "42": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "green", "#78b892"),
        "43": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "blue", "#de8f78"),
        "44": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("normal_colors"), "yellow", "#6791c9"),
        ...
        "101": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "green", "#e8646a"),
        "102": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "green", "#81c19b"),
        "103": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "blue", "#e79881"),
        "104": __get_color(ansi_escape_colors.get(__color_scheme, {}).get("bright_colors"), "yellow", "#709ad2"),
